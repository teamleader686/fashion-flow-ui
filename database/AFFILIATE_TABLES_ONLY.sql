-- ============================================
-- AFFILIATE TABLES ONLY - NO ORDERS REFERENCE
-- ============================================
-- Yeh file SIRF affiliate tables banayegi
-- Orders table ka koi reference NAHI hai
...
-- 3. AFFILIATE ORDERS TABLE (NO FOREIGN KEY TO ORDERS)
...
SELECT '📝 Total 6 tables + functions + triggers + RLS' as info;
