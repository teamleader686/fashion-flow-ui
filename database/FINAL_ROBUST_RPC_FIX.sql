-- ========================================================
-- 🚀 FINAL ROBUST REPAIR SCRIPT (Fixes 404 & Dependency Errors)
-- ========================================================
-- This script is designed to be independent and fix all previous errors.
...
-- 2. ROBUST VALIDATION FUNCTION (Accepting TEXT to avoid 404 type mismatches)
CREATE OR REPLACE FUNCTION public.validate_coupon_v2(
  p_code TEXT,
  p_user_id TEXT, -- Changed to TEXT for safer matching from frontend
  p_cart_total NUMERIC,
  p_product_ids TEXT[], -- Changed to TEXT[] for safer matching
